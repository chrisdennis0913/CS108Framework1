...
public class Player {
	...
	/*
	 * private void initActions() { actions.put("walking", new Walking(this, 6,
	 * "walk")); actions.put("standing", new Standing(this, 1, "stand",
	 * (Walking) actions.get("walking"))); actions.put("talking", new
	 * Talking(this, 1, "stand")); actions.put("grabbing", new Grabbing(this, 1,
	 * "stand")); for (ItemSub itm : game.getInventory()) System.out.println(itm
	 * + "in Player"); actions.put("attacking", new Attacking(this, 3, "attack",
	 * game)); }
	 */
	...
	public void render(Graphics2D g) {
		...
		SystemFont font = new SystemFont(new Font("Arial", Font.BOLD, 20),
				new Color(255, 0, 0));
