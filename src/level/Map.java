...
public class Map extends AbstractTileBackground {
    ...
    public Map (BaseLoader bsLoader, BaseIO bsIO) {
        ...
        String[] lowerTile =
            FileUtil.fileRead(bsIO.getStream("resources/scenery/map00.lwr"));
        String[] upperTile =
            FileUtil.fileRead(bsIO.getStream("resources/scenery/map00.upr"));
        ...
        chipsetE =
            new Chipset(bsLoader.getImages("resources/scenery/ChipSet2.png",
                                           6,
                                           24,
                                           false));
        chipsetF =
            new Chipset(bsLoader.getImages("resources/scenery/ChipSet3.png",
                                           6,
                                           24));

        chipset = new Chipset[16];
        BufferedImage[] image =
            bsLoader.getImages("resources/scenery/ChipSet1.png", 4, 4, false);
        int[] chipnum =
