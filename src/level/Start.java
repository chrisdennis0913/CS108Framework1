...
public class Start extends Level {
	...
	protected void addNPCs() {
		...
		int[] loc = new int[] {
				game.getBG().getWidth() / 2 - priest.getImage().getWidth() / 4,
				90 };
		priest.add(loc, 6);
	...
	protected void addScenery() {
		...
		int[] statloc = new int[] {
				game.getBG().getWidth() / 2 - statue.getImage().getWidth() / 4,
				0 };
	...
	protected void addItems() {
		Item sword = new Item(game, "sword");
		int[] loc = new int[] { game.getBG().getWidth() / 2 - 10,
